# auto-generated IOBR deconvolution (module 492) for GSE249550  [SEED 123]
suppressMessages({library(IOBR); library(tidyverse)})
set.seed(123)
eset <- as.matrix(read.csv("./out_05_bulk/stageB/GSE249550_expr_for_deconv.csv", row.names=1, check.names=FALSE))
...
write.csv(tme, "./out_05_bulk/stageB/GSE249550_deconv.csv")
