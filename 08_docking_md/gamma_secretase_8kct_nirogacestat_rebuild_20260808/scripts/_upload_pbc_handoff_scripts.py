...
FILES = (
    "scripts/_remote_launch_rep02_pbc.sh",
    "scripts/_remote_launch_rep03_pbc.sh",
    "scripts/seal_primary_postprocessing_manifest.py",
    "scripts/resume_primary_pbc_trajectories.py",
    "scripts/_remote_resume_cpu_clone_work.sh",
    "scripts/_remote_retry_toolchain_v3.sh",
    "scripts/_remote_retry_gmx_mmpbsa_v5.sh",
    "scripts/_remote_retry_gorder_v4.sh",
    "scripts/_remote_retry_gorder_v5.sh",
    "scripts/_remote_accept_gmx_mmpbsa_v5.sh",
